...
public class Admin_Home extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.all_c);
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent back1 = new Intent(Admin_Home.this, Login_Activity.class);
                startActivity(back1);
                finish();
            }
        });
        ...
        recyclerView.addItemDecoration(new template_list.GridSpacingItemDecoration(4, dpToPx(16), true));
...
//                if(position == 0){
//                    Intent intent1 = new Intent(Admin_Home.this,Admin_Files_List.class);
