...
public class Details_Hostel extends AppCompatActivity {
    ...
    int floor_map_camera = 288;
    int floor_map_gallery = 298;
    int floor_map_edit_final = 300;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_hostel);
    ...
    public void onClickPPT(View view){
        ...
        EditText bedroom = findViewById(R.id.bed_room);
        EditText hallroom = findViewById(R.id.hall_room);
        EditText kitchen = findViewById(R.id.kitchen);
        EditText furnished_shell = findViewById(R.id.furnished);
        EditText no_of_washrooms = findViewById(R.id.no_washrooms);
        ...
        Toast.makeText(Details_Hostel.this, "Loading", Toast.LENGTH_SHORT).show();

        try{
            Presentation pres = new Presentation(getResources().openRawResource(R.raw.template_hostel));       // ***** you have to change this ppt accordingly *****
            ...
            tf6.setText("Bedroom : " + bedroom.getText());

            tf7.setText("Hallroom : " + hallroom.getText());

            tf8.setText("Kitchen : " + kitchen.getText());

            tf9.setText("Furnished/Semi Furnished/Bare Shell : " + furnished_shell.getText());

            tf10.setText("No of Washrooms : " + no_of_washrooms.getText());

            tf11.setText("Parking : " + parking.getText());

            tf12.setText("Security Deposit : " + security_deposit.getText() + " Sq.ft.");

            tf13.setText("Asking Rent : " + asking_rent.getText());

            tf14.setText("Description : " + description.getText());
            ...
            Toast.makeText(Details_Hostel.this, "successful in sd card", Toast.LENGTH_SHORT).show();
        }
        catch(Exception e){
            Toast.makeText(Details_Hostel.this, "unsuccessful in sd card", Toast.LENGTH_SHORT).show();
            e.printStackTrace();
        }
    ...
    public void onClickExcel(View view){
        ...
        try{
            ...
            workbook.getWorksheets().get(0).getCells().get("B2").setValue(consultant_name.getText());
            workbook.getWorksheets().get(0).getCells().get("C2").setValue(consultant_contact.getText());
            workbook.getWorksheets().get(0).getCells().get("D2").setValue(area_carpet.getText());
            workbook.getWorksheets().get(0).getCells().get("E2").setValue(floor.getText());
            workbook.getWorksheets().get(0).getCells().get("F2").setValue(bedroom.getText());
            workbook.getWorksheets().get(0).getCells().get("G2").setValue(hallroom.getText());
            workbook.getWorksheets().get(0).getCells().get("H2").setValue(kitchen.getText());
            workbook.getWorksheets().get(0).getCells().get("I2").setValue(furnished_shell.getText());
            workbook.getWorksheets().get(0).getCells().get("J2").setValue(no_of_washrooms.getText());
            workbook.getWorksheets().get(0).getCells().get("K2").setValue(parking.getText());
            workbook.getWorksheets().get(0).getCells().get("L2").setValue(security_deposit.getText());
            workbook.getWorksheets().get(0).getCells().get("M2").setValue(asking_rent.getText());

            workbook.getWorksheets().get(0).getCells().get("N2").setValue(description.getText());
    ...
    protected void onActivityResult(int requestcode, int resultcode, Intent data) {
        ...
        if(resultcode == RESULT_OK){
            ...
            if(requestcode == front_camera) {
                ...
                ImageView upload_floor_map = findViewById(R.id.floor_map_upload_image);
                Bitmap bt2;
    ...
    public void startEditor(Uri uri, int req_c){
        Intent intent = new Intent(Details_Hostel.this, DsPhotoEditorActivity.class);
